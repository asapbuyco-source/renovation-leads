...
const services = [
  {
    ...
    image: "https://picsum.photos/seed/african-living-room/600/400"
  },
  {
    ...
    image: "https://picsum.photos/seed/african-kitchen-modern/600/400"
  },
  {
    ...
    image: "https://picsum.photos/seed/african-roof/600/400"
  },
  {
    ...
    image: "https://picsum.photos/seed/african-painter/600/400"
  },
  {
    ...
    image: "https://picsum.photos/seed/african-electrician/600/400"
  },
  {
    ...
    image: "https://picsum.photos/seed/african-plumber/600/400"
  }
];
    ...
    <div className="bg-slate-50 min-h-screen">
      ...
      <div className="relative bg-slate-900 py-24 lg:py-32 overflow-hidden">
        <div className="absolute inset-0">
          <img 
            src="https://picsum.photos/seed/african-contractors-modern-building/1920/1080" 
            alt="African contractors working on a modern building" 
      ...
      <div className="bg-white py-20 border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-serif font-bold text-slate-900 mb-6">Serving All Major Cities in Cameroon</h2>
              ...
              <div className="flex flex-wrap gap-3">
                {['Douala', 'Yaoundé', 'Buea', 'Limbe', 'Bamenda', 'Kribi', 'Bafoussam'].map((city) => (
            ...
            <div className="bg-slate-100 rounded-2xl p-2 shadow-inner">
              <img 
                src="https://picsum.photos/seed/cameroon-map-view/600/400" 
                alt="Map of Cameroon coverage" 
